...
<!-- - MRK:TOOLS_README_PROTOCOL — Access protocol (P1 v3) | tools,readme,protocol,access,p1 | L11-17 -->
<!-- - MRK:TOOLS_README_RULES — Hard rules (P2 v2) | tools,readme,rules,hard,p2 | L18-26 -->
<!-- - MRK:TOOLS_README_CONFLICT — Conflict-resolution | tools,readme,conflict,resolution | L27-34 -->
<!-- - MRK:TOOLS_README_CUSTOM — Custom context (preserved) | tools,readme,custom,context,preserved | L35-47 -->
<!-- NAV-LEN: 4 entries | Integrity-hash: 9ae2d809afdb8c65 | Last-indexed: 2026-04-26T23:37:20Z -->
